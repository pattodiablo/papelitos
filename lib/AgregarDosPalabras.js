...
//Agregar palabras nuevas
	...
	create: function() {
			...
			this.rdnBtn = this.add.button(110, 530, 'rdnBtn' , this.iniciarJuego2, this);
			this.jugarBtn = this.add.button(130, 430, 'jugarBtn' , this.iniciarJuego, this);
  ...
  iniciarJuego: function(){
  		...
  		this.myInput1.destroy();
  		this.myInput2.destroy();
  		this.myInput1.inputEnabled = false;
  		 this.myInput2.inputEnabled = false;
 		myInput.inputEnabled = false;
